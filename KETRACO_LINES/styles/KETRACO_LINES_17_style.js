var size = 0;
var placement = 'point';
function categories_KETRACO_LINES_17(feature, value, size, resolution, labelText,
                       labelFont, labelFill) {
...
var style_KETRACO_LINES_17 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_KETRACO_LINES_17(feature, value, size, resolution, labelText,
                          labelFont, labelFill);
