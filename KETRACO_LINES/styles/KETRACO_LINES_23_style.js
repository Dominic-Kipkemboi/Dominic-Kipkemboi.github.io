...
function categories_KETRACO_LINES_23(feature, value, size, resolution, labelText,
                       ...
                       placement) {
                switch(value.toString()) {case '132kVCOMPLETED':
...
case '400kVONGOING':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(247,28,25,1.0)', lineDash: [10,5], lineCap: 'square', lineJoin: 'bevel', width: 3}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
case '132kVONGOING':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(31,214,255,1.0)', lineDash: [10,5], lineCap: 'square', lineJoin: 'bevel', width: 3}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
case '220kVONGOING':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(72,111,229,1.0)', lineDash: [10,5], lineCap: 'square', lineJoin: 'bevel', width: 3}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
case '500HVDCONGOING':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(218,75,211,1.0)', lineDash: [10,5], lineCap: 'square', lineJoin: 'bevel', width: 3}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
