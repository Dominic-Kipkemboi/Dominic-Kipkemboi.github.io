var size = 0;
var placement = 'point';
function categories_KETRACO_LINES_24(feature, value, size, resolution, labelText,
...
var style_KETRACO_LINES_24 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_KETRACO_LINES_24(feature, value, size, resolution, labelText,
